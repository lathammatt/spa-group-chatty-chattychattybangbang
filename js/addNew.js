var Chatty = (
	function applyNew(newChat){
		...
		var messageCard = `<div class="lightbox"><h3>${preloaded.messages[(preloaded.messages.length)-1].message}</h3><button id="card-${preloaded.messages.length-1}">Delete</button></div>`;
